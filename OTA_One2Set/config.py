...
def model_opts(parser):
    ...
    parser.add_argument('-use_optimal_transport', action="store_true", default=False,
                        help='whether to use optimal transport as assign algorithm')
    parser.add_argument('-top_candidates', type=int, default=10,
                        help='num of top candidates')
    parser.add_argument('-k_strategy', type=str, default="",
                        help='strategy to assign k to targets')
    parser.add_argument('-assign_temperature', type=float, default=1,
                        help='temperature in assign algorithm')
    # parser.add_argument('-loss_matching_scale', action="store_true", default=False,
    #                     help='whether use matching degree to calculate loss')
    parser.add_argument('-adaptive_lr_scale', action="store_true", default=False,
                        help='whether use adaptive learning rate scaling')
    parser.add_argument('-null_cost_zero', action="store_true", default=False,
                        help='whether to forcibly set cost of `null trg` as zero.')
    parser.add_argument('-interrupt_cost', action="store_true", default=False,
                        help='whether to add small gaussian noise to cost matrix.')
...
def train_opts(parser):
    ...
    parser.add_argument('-stats_only', action="store_true", default=False,
                        help='turn on the switch if statistical analysis is needed, and there will be no param updates.')
